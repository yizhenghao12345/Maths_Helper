...
export const enUS: typeof zhCN = {
  ...
  console: {
    ...
    aiDebug: {
      ...
      followAiConfig: 'Leave blank to follow AI config',
      update: 'Save Config',
      ...
      ocrProviderPlaceholder: 'Leave blank to follow AI provider',
      ocrModelPlaceholder: 'Leave blank to use the provider default OCR model',
      ocrApiKeyPlaceholder: 'Leave blank to reuse AI key',
      ocrBaseUrlPlaceholder: 'Leave blank to reuse AI base URL',
      enabled: 'Enabled',
      disabled: 'Disabled',
